...
import com.deadlybeat.service.UserService;
...
public class UserController {
	...
	@GetMapping(value = "/usersByMulThread",produces = "Application/json")
	public ResponseEntity getUser() {
		
		//here we have configure 3 task but in config file we have thread pool size as 2 only
		...
		//join all tasks-all of method wait until finish of execution of each thread and once all 3 done it will join
